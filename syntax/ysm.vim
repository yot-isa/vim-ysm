...
syntax match ysmKeyword display "\<rtf[1248^]?\?\>"
syntax match ysmKeyword display "\<rtb[1248^]?\?\>"
...
syntax match ysmKeyword display "\<rtl[1248]?\?\>"
syntax match ysmKeyword display "\<rtr[1248]?\?\>"
